    ...
    return (
        <>
            <button 
                ...
                className="bg-[#1b5e1b] text-white mx-auto mt-8 px-4 py-2 rounded hover:bg-green-700 transition-colors"
            >
            ...
            >
                <div className="p-4 rounded bg-[#1b5e1b] text-left text-white 2xl:col-span-1">
